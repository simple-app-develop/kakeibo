...
!(function (t, e) {
    ...
    function B(t, e) {
        for (
            ...
            n &&
            (n === Rt.ghost || "none" === R(n, "display") || (e && !h(n, e)));
    ...
    var x = [],
        ...
        O = {
            mount: function (e) {
                for (var t in M)
                    !M.hasOwnProperty(t) || t in e || (e[t] = M[t]);
        ...
        _triggerDragStart: function (t, e) {
            (e = e || ("touch" == t.pointerType && t)),
                !this.nativeDraggable || e
                    ...
                    : (d(z, "dragend", this),
                      d(q, "dragstart", this._onDragStart));
            try {
                document.selection
                    ? Ht(function () {
        ...
        _onDragOver: function (n) {
            ...
            function N(t) {
                return (
                    ...
                    ((s === z && !z.animated) || (s === l && !s.animated)) &&
                        (ht = null),
                    e.dragoverBubble ||
                        n.rootEl ||
                        s === document ||
                        (z.parentNode[j]._isOutsideThisEl(n.target),
                        t || Pt(n)),
                    !e.dragoverBubble &&
                        n.stopPropagation &&
                        n.stopPropagation(),
                ...
                return (
                    (t.prototype = {
                        ...
                        dragStartGlobal: function (t) {
                            ...
                            !this.isMultiDrag &&
                                ie &&
                                ie.multiDrag._deselectMultiDrag(),
                                se.forEach(function (t) {
                                    t.sortableIndex = F(t);
                                }),
